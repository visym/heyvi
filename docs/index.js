...
"ref":"heyvi",
"url":0,
"doc":"Hey Vi  Versioning To determine what heyvi version you are running you can use: >>> heyvi.__version__ >>> heyvi.version.is_at_least('1.11.1')  Contact Visym Labs  "
},
{
...
"url":3,
"doc":"Youtube Live stream"
},
{
"ref":"heyvi.system.Recorder",
"url":3,
"doc":"Record a livestream to an output video file This will record an out streaming to the provided outfile >>> R = Recorder('/tmp/out.mp4', framerate=5) >>> R(vipy.video.Scene(url='rtsp:  .', framerate=30), seconds=60 60) To buffer to memory, you do not need this recorder, use (for small durations): >>> v = vipy.video.Scene(url='rtsp:  .', framerate=30).duration(seconds=3).load() This will record three seconds from the provided RTSP stream."
},
{
